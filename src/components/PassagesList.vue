    ...
    article.passagesList
        ...
        ul.unstyled
            li(v-for="passage of passagesOverview")
                ...
                a(v-link="{name: 'passage', params: {pid: passage.pid}}", "@click"="openPassage(passage.pid)", v-hilite-term="getPassagesFiltering") {{passage.title}}
...
<script>
    import {openPassage,setPassagesSorting,setPassagesFiltering,} from '../vuex/actions';
